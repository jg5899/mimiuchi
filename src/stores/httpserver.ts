...
export const useHttpServerStore = defineStore('httpserver', () => {
  ...
  // Opt-in: broadcast draft (interim) English captions to display clients as the
  // speaker talks, instead of only finalized lines. Default OFF to preserve the
  // existing finals-only behavior (which avoids caption flicker).
